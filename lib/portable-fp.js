 ...
 * 
 * TODO: add omit, assoc, dissoc, juxt
 * 
 * @author Evan King
 */
module.exports = (function() {
    ...
    const core = {
        equals: (a, b) => _value(a) === _value(b) || (a != a && b != b),
    };
    ...
    let optional; with(core) { optional = {
        ...
        contains: (v, list) => _keys(list).findIndex(x => equals(list[x], v)) > -1,
    ...
    return Object.freeze(_map(crry, Object.assign(core, optional), {}));
